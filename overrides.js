...
const origin = [
    await override_variables.get("home", {type: "json"}), // { 'new_host': 'home.erfianugrah.best', 'incoming_path': '/home', 'incoming_port': 1234 }
    await override_variables.get("net", {type: "json"}), // { 'new_host': 'www.erfianugrah.net', 'incoming_path': '/net', 'incoming_port': 1234 }
    await override_variables.get("ml", {type: "json"}) // { 'new_host': 'www.erfi.ml', 'incoming_path': '/ml', 'incoming_port': 1234 }
]
